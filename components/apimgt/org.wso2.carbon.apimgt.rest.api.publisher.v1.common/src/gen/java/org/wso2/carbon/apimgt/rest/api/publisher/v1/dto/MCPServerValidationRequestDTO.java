...
public class MCPServerValidationRequestDTO   {
  ...
  /**
   * Whether to append /mcp when validating the MCP server endpoint. Defaults to the server-wide MCPPathAppendEnabled setting if omitted. 
   **/
  ...
  @ApiModelProperty(value = "Whether to append /mcp when validating the MCP server endpoint. Defaults to the server-wide MCPPathAppendEnabled setting if omitted. ")
