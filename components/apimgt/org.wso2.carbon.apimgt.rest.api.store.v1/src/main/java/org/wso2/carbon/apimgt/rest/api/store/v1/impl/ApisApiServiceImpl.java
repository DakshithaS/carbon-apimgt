    ...
    public Response apisApiIdSwaggerGet(String apiId, String environmentName,
        ...
        try {
            ...
            if (StringUtils.isEmpty(environmentName)) {
                ...
                List<String> deployedEnvironments = APIUtil.getDeployedEnvironments(apiId);
                ...
                Map<String, Environment> validEnvironments = existingEnvironments.entrySet().stream()
                        .filter(entry -> deployedEnvironments.contains(entry.getKey()))
                ...
                for (String environmentNameOfApi : api.getEnvironments()) {
                    if (validEnvironments.get(environmentNameOfApi) != null) {
